...
import astronautImage from "../assets/home.png"; // Replace with correct path
import smartTargetingIcon from "../assets/home.png"; // Replace with correct path
import executionIcon from "../assets/home.png"; // Replace with correct path
import measurementIcon from "../assets/home.png"; // Replace with correct path
import lookalikeImg from "../assets/home.png"; // Replace with correct path
import customAudienceImg from "../assets/home.png"; // Replace with correct path
import crmAttributesImg from "../assets/home.png"; // Replace with correct path
import SmartTargeting from "../Components/CapabilitiesTab/SmartTargeting";

const CapabilitiesMeasurement = () => {
  return (
    <>
        ...
        <div className="bg-[#F8F9FA] py-16 px-6">
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            ...
            <div className="p-6 rounded-lg shadow-lg">
              ...
              <h3 className="text-lg font-semibold text-gray-700">Simple Execution</h3>
              <p className="text-sm text-gray-600">Deploy Campaigns in Days, Not Months</p>
            </div>
            ...
            <div className="bg-[#0A2C47] text-white p-6 rounded-lg shadow-lg">
              ...
              <h3 className="text-lg font-semibold text-[#00C4FF]">Strong Measurement</h3>
              <p className="text-sm">Track Campaign Performance in Real-Time</p>
            </div>
        ...
        <div className="bg-white py-16 px-6">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-center text-3xl font-bold text-[#0A2C47] mb-10">
              With Strong Measurement You Can:
            </h2>
...
export default CapabilitiesMeasurement;
