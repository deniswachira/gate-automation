...
const BusinessProcessFlowSection: React.FC<BusinessProcessProps> = ({
  title,
  description,
  features,
  ctaText,
  ...
  return (
    <motion.section
      className={`flex flex-col md:flex-row items-center gap-12 px-8 py-16 ${
...
export default BusinessProcessFlowSection;
